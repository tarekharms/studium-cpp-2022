...
void Shape::nonVirtual(void)
{
    ansiConsole.printText(0, 0, "Shape::nonVirtual()", _color);
}
...
void Circle::nonVirtual(void)
{
    ansiConsole.printText(0, 0, "Circle::nonVirtual()", _color);
}
...
void Rectangle::nonVirtual(void)
{
    ansiConsole.printText(0, 5, "Rectangle::nonVirtual()", _color);
}
